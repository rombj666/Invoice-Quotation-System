...
type QuotationPayload = {
  ...
  packageSnapshot?: { price: number; includedBaristaFee?: number };
  pricingBreakdown?: { extraBaristaFee?: number };
};
...
function getLegacyInvoiceBaristaPricing(totalCups: number, duration: "HALF_DAY" | "FULL_DAY") {
