...
export function previewQuotationPricing(data: Pick<QuotationData, "totalCups" | "serviceDuration" | "serviceDates" | "selectedPackageId" | "packageCode" | "extendToEightHours" | "cartStyle" | "selectedOptions" | "discountCode">): Promise<QuotationPricingPreview> {
