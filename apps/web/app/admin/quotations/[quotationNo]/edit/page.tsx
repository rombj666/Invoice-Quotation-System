...
export default function AdminQuotationEditPage() {
  ...
  const updateDuration = (id: string, durationMode: "HALF_DAY" | "FULL_DAY") => updateDate(id, { durationMode, startTime: "09:00", endTime: durationMode === "FULL_DAY" ? "17:00" : "13:00" });
